    ...
    <div class="container">
     <div class='Images-container'>
        <div class='Image-container responsive Car1'>
          <img src="./src/static/car2.jpeg" class="img-fluid img-thumbnail" width="400px" height="250px" alt="Responsive Image"/>
        </div>

        <div class='Image-container Other-cars mb-5'>
          <img src="./src/static/car1.jpeg" class="img-fluid img-thumbnail" width="400px" height="250px"/>
        </div>
        <div class='Image-container Other-cars'>
          <img src="./src/static/car3.jpeg" class="img-fluid img-thumbnail" width="400px" height="250px"/>
        </div>
      </div>
